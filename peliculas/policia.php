		...
		<div id="featured">
			<div class="container">
				<div class="row">
					...
					<div class="3u">
						<section>
							<h1>Una Policia en apuros</h1>
							<a class="image full"><img src="images/polis.jpg" alt=""></a>
					...
					<div class="3u">
						<section>
							<h1>Trailer</h1>
              <iframe width="560" height="380" src="https://www.youtube.com/embed/EiTjynXnHA0?ecver=1" frameborder="0" allowfullscreen></iframe>
              <br><br>
              ...
              if (isset($_SESSION['usuario'])) {
                ...
                echo "<h2>Inserte su comentario</h2>";
                 ?>
                <form class="" action='policia.php' method='post'>
                <input type="text" name="comentario" value="0"><br><br>
                <input type="hidden" name="id_pelicula" value= "3">
              ...
              $listacomentarios=$coment->mostrarComentario(3);
            ...
            echo "<a>Comentario: " .$comentario['comentario'] ."<br><br></a>";
               ...
               ?>
                ...
                <li><p> <b>Duración</b>: 88 min </p></li>
								...
								<li><p> <b>Género</b>: Comedia </p></li>
								<li><p> <b>Estreno</b>: 09/06/2017 </p></li>
								<li><p> <b>Directores</b>: Dany Boon </p></li>
								<li><p> <b>Actores</b>: Alice Pol, Dany Boon, Michel Blanc, Patrick Mille, Sabine Azéma, Yvan Attal </p></li>
								<li><p> <b>Guionistas</b>: Dany Boon, Sarah Kaminsky </p></li>
								<li><p> <b>Productores</b>: Artémis Productions, Les Productions Du Ch'timi, Pathé, Tf1 Films Productions </p></li>
								<?php
								if (isset($_SESSION['usuario'])) {
								 ?>
								 		<h1>RESERVA</h1><br><br>
                          ...
                          <input type="hidden" name="id_pelicula" value= "3"><br><br>
